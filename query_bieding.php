...
checkVerhoging($huidigBod, $bedrag);
...
function checkVerhoging ($huidigBod, $bedrag)
{
	if ($huidigBod < 50.00 && $huidigBod > 0.00) 
	{
		if ($bedrag + 0.50 < $huidigBod) 
		{
			$input_check = false;
